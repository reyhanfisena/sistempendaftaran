...
// Fetch Data
$sql = "SELECT * FROM pengguna WHERE role = 2";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                ...
                                <td>
                                    ...
                                    <a href='penilai.php?delete=" . $row['idpengguna'] . "' class='btn btn-danger btn-sm'><i class='fas fa-trash'></i></a>
                                </td>
                            </tr>";
                        }
                    } else {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="penilai.php">
